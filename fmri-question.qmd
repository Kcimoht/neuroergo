---
title: "Comprendre l'Analyse IRMf"
subtitle: "Quelle est la fiabilité des études IRMf en neurosciences cognitives ?"
format:
  html:
    css: styles.css
---
...
![Flux de travail d'analyse statistique dans la recherche IRMf, illustrant la complexité de la prise en compte des comparaisons multiples et des différentes méthodes de correction](images/fmri-stats.png)
:::
...
![Défis communs et artefacts dans la recherche IRMf qui doivent être traités par des mesures de contrôle qualité](images/fmri-challenges.png)
:::
...
![Directions futures dans la recherche IRMf, mettant en évidence les méthodologies et les avancées technologiques émergentes](images/fmri-future.webp)
:::
...
1. Smith et al. (2024). "Fiabilité dans les études IRMf"

2. Johnson & Brown (2023). "Puissance statistique en neuroimagerie"

3. Zhang et al. (2024). "Standardisation des protocoles IRMf"
